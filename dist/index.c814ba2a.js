(()=>{async function e(){try{let e=await fetch(process.env.API_URL);return await e.json()}catch(e){console.error("Erro ao buscar dados:",e)}}process.env.API_URL;let t=document.getElementById("modal"),n=document.getElementById("modal-img"),c=document.getElementById("caption"),o=document.querySelector(".close");t.style.display="none";let r=document.querySelector(".image-grid");async function i(){let o=await e();try{let e=o.map(e=>`
...
//# sourceMappingURL=index.c814ba2a.js.map
